...
// Now inside SidebarProvider — useSidebar() resolves here.
...
<template>
    <div class="flex h-dvh w-full overflow-hidden bg-bg-surface">
        <Sidebar class="border-none">
            ...
            >
                <RouterLink to="/dashboard" @click="closeOnMobile">
                    <BrandMark />
                </RouterLink>
                <WorkspaceSwitcher />
            </SidebarHeader>
            ...
            <SidebarContent>
                <SidebarGroup>
                    ...
                    >
                        ...
                        {{ item.label }}
                        <Badge v-if="item.disabled" class="ml-auto">Soon</Badge>
                    </SidebarItem>
                </SidebarGroup>
            </SidebarContent>
        ...
        >
            ...
            <div class="p-4 pt-8 pb-8 md:px-8">
                <router-view />
            </div>
        </main>
    </div>
